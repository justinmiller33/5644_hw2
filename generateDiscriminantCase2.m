function [scoreA, scoreB] = generateDiscriminantCase2(mu, sigma, priorW1, data)
...
for i=1:length(data.a)
    ...
    g1 = case2(mu.a, point, sigma.a, priorW1);
    g2 = case2(mu.b, point, sigma.b, 1-priorW1);
    scoreA = [scoreA ; g1,g2];
end
...
title("Decision Bound: Accuracy = 94.50")
xlabel("X_1")
ylabel("X_2")
...
% OUTPUT: Accuracy 1.7b) 93.50
% OUTPUT: Accuracy 1.7c) 88.25
% OUTPUT: Accuracy 1.7e) 95.25
% OUTPUT: Accuracy 1.7f) 94.50